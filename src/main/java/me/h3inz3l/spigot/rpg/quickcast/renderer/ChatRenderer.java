...
public class ChatRenderer implements QuickcastRenderer {

    private String color;

    public ChatRenderer(QuickcastAPI quickcastAPI) {
    ...
    public void render(Player player, List<MouseKey> mouseKeys) {
        ...
        player.spigot().sendMessage(ChatMessageType.CHAT, TextComponent.fromLegacyText(color + text));
    }
